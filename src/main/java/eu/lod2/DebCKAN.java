...
public class DebCKAN extends CustomComponent
{
	...
	"ckan-dataset-museums-in-italy",
	"ckan-dataset-mondial",
	"ckan-dataset-linked-open-senate",
	"ckan-dataset-lichfield-spending",
	"ckan-dataset-italian-public-schools-linkedopendata-it",
	"ckan-dataset-iso-3166-2-data",
	"ckan-dataset-grrt",
	"ckan-dataset-chronicling-america",
	"ckan-dataset-cablegate"
    };

    private String introduction = 
	"The LOD2 stack includes downloadable datasets as debian packages." +
