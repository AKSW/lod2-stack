...
/**
 * a generic class to display a url in an iframe
 */
//@SuppressWarnings("serial")
public class IframedUrl extends CustomComponent
{
    ...
    public IframedUrl(LOD2DemoState st, String urlref) {
        ...
        this.updateUrl(urlref);
    }

    protected void updateUrl(String urlref){
