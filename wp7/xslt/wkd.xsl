...
<metaInformation>
	<scenarios>
		...
		<scenario default="no" name="Herzberg_TV-V_entgelttabellen_niederschriftserklaerun" userelativepaths="yes" externalpreview="no" url="..\Data\product\stroebele_markeng_9_fund_nat.xml" htmlbaseurl=""
