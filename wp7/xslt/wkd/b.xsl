...
<!-- todo
add structure 
- container-block - no (spec)
- container-auspraegung - no (spec)
 -->
...
<xsl:template match="beitrag-quelle">
	<xsl:apply-templates>
...
<xsl:template match="beitrag/lexikon-eintrag | beitrag-ebene/lexikon-eintrag" mode="#default top-level"/>
