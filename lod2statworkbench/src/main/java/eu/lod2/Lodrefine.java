...
public class Lodrefine extends CustomComponent
{
    ...
    private void initLogin() {
		try {
			...
			String query = "select ?u ?p ?s from <" + state.getConfigurationRDFgraph() + "> where {<" + state.getConfigurationRDFgraph() + "> <http://lod2.eu/lod2statworkbench/configures> <http://localhost/lodrefine>. <http://localhost/lodrefine> <http://lod2.eu/lod2statworkbench/password> ?p. <http://localhost/lodrefine> <http://lod2.eu/lod2statworkbench/username> ?u. <http://localhost/lodrefine> <http://lod2.eu/lod2statworkbench/service> ?s.} LIMIT 100";
